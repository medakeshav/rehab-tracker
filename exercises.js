    ...
    phase2: [
        // Continue Phase 1 exercises, plus add these:
        {
            ...
            instructions: {
                ...
                sets: '3 sets',
                why: 'Builds single-leg strength, improves balance, and mimics stair climbing',
                tips: [
                    'Drive through heel of elevated foot',
                    'Keep chest up, core engaged',
                    'Step down slowly - control the descent',
                    'Start with lower step, progress higher',
                    'Right leg gets extra reps',
                ],
            },
        },
        {
            ...
            instructions: {
                ...
                sets: '3 sets',
                why: 'Elite single-leg strength builder, exposes and corrects imbalances',
                tips: [
                    'This is HARD - start bodyweight only',
                    'Front knee tracks over toes',
                    "Don't let front knee cave inward",
                    'Chest stays up, no leaning forward',
                    'Back leg is just for balance',
                    'Right leg will be more challenging',
                ],
            },
        },
        {
            ...
            instructions: {
                ...
                steps: [
                    ...
                    'Reach hand toward floor (or hold weight)',
                    'Feel stretch in standing leg hamstring',
                    'Pull back up using glute and hamstring',
                    'Body should form a "T" shape at bottom',
                ],
                reps: '10 each leg (15 right)',
                sets: '3 sets',
                why: 'Challenges balance, builds posterior chain, improves hip hinge pattern',
                tips: [
                    'This requires serious balance',
        ...
        },
        {
            ...
            instructions: {
                ...
                steps: [
                    ...
                    'Take 15 steps right, then 15 steps left',
                    'Keep tension in band the entire time',
                ],
                reps: '15 steps each direction (22 right)',
                sets: '3 sets',
                why: 'Activates glute med dynamically, builds hip stability during movement',
                tips: [
                    'Keep knees pushing out against band',
                    "Don't let knees cave inward",
                    'Stay low in athletic stance',
                    'Feel burn in side of glutes',
                    'Constant tension - no rest at center',
                    'Progress: stronger band or lower stance',
                ],
            },
        },
        {
            ...
            instructions: {
                ...
                steps: [
                    'Stand on one leg',
                    'Reach other leg forward, tap toe on ground',
                    'Return to center, maintain balance',
                    'Reach same leg to the side, tap',
                    'Return to center',
                    'Reach same leg backward, tap',
                    'Return to center',
                    'Repeat for 8 cycles in each direction',
                ],
                reps: '8 reaches per direction, each leg (12 right)',
                sets: '2 sets',
                ...
                tips: [
                    ...
                    'Progress: reach farther, remove arm help',
                ],
            },
        },
        {
            ...
            instructions: {
                ...
                steps: [
                    ...
                    'Elbows pass inside knees at bottom',
                    'Drive through heels to stand',
                ],
                reps: '12-15',
                sets: '3 sets',
                why: 'Safe squat progression, builds bilateral leg strength with spinal support',
                tips: [
    ...
    phase3: [
        // Continue Phase 2 exercises, plus add these:
        {
            ...
            instructions: {
                ...
                steps: [
                    'Use sturdy box or step (12-18 inches)',
                    'Place right foot fully on box',
                    'Explosively push through right heel',
                    'Drive left knee up toward chest as you rise',
                    'Stand tall at top',
                ...
                reps: '10 each leg (15 right)',
                sets: '3 sets',
                why: 'Builds explosive power, mimics running mechanics, challenges single-leg power',
                tips: [
                    'Advanced exercise - need good base strength',
                    'Explosive drive up, controlled descent',
                    'Land softly when stepping down',
                    'Knee drive is key - get knee to waist height',
                    'All power from elevated leg',
                    'Progress: higher box, add weight vest',
                ],
            },
        },
        {
            ...
            instructions: {
                ...
                reps: '5-8 hops per direction, each leg (8 right)',
                sets: '3 sets',
                why: 'Plyometric training - builds reactive strength, ankle stability, and power',
                tips: [
                    'Most advanced exercise - need excellent control',
                    'Land softly with quiet feet',
                    'Knee should track straight, not collapse',
                    'Start with small hops, progress bigger',
                    'This is high impact - ensure knee is ready',
        ...
        },
        {
            ...
            instructions: {
                ...
                steps: [
                    'Hold heavy dumbbell or kettlebell in one hand',
                ...
                sets: '3 sets',
                why: 'Unilateral load challenges core stability, builds grip strength, functional strength',
                tips: [
                    'Use challenging weight - should be hard',
                    'Walk with normal gait, no limping',
                    'Squeeze handle hard',
                    'Breathe normally, stay braced',
